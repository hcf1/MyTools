...
import com.example.batterydetails.fragment.CTL_ACTION
import com.example.batterydetails.fragment.UPDATE_ACTION
...
class MusicService : Service()
{
	...
	override fun onCreate()
	{
		...
		mPlayer.setOnCompletionListener {
			...
			sendIntent.`package` = "com.example.batterydetails"
